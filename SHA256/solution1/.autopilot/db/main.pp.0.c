...
# 90 "C:\\Xilinx\\Vitis_HLS\\2020.2\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include\\stddef.h" 3
typedef unsigned short wchar_t;
...
__attribute__((sdx_kernel("SHA256", 0))) char* SHA256(char* input,char* hash);
...
char* hexToBin(char* string, char* bits){
    int i =0;
    VITIS_LOOP_318_1: while(string[i]!='\0'){
        if(i>1){
            cat(bits,hToB(string[i]));
        }
        i++;
    }
