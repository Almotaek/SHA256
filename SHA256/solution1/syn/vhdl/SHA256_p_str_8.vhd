...
architecture rtl of SHA256_p_str_8_rom is 
...
architecture arch of SHA256_p_str_8 is
    component SHA256_p_str_8_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    SHA256_p_str_8_rom_U :  component SHA256_p_str_8_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
